...
export const HearthSvgComponent: FC<PropsAreas> = ({x = 0, y = 0, opacity = 1, title = '', ...props }) => {

  return (

  <AreasTemplateSvgComponent backgroundColor={'#E2D0FF'} mainColor={'#FF0062'} x={x} y={y} title={title} opacity={opacity} {...props}>
    <Path
      fill="#FF0062"
      opacity={opacity}
