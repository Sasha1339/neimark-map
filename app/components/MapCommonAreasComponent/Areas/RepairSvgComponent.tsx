...
export const RepairSvgComponent: FC<PropsAreas> = ({x = 0, y = 0, opacity = 1, title = '', ...props }) => {

  return (
  <AreasTemplateSvgComponent backgroundColor={'#E0F9FF'} mainColor={'#006C66'} x={x} y={y} title={title} opacity={opacity} {...props}>
    <Path
      opacity={opacity}
      fill="#006C66"
