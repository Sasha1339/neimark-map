...
export const SchoolSvgComponent: FC<PropsAreas> = ({x = 0, y = 0, opacity = 1, title = '', ...props }) => {

  return (
  <AreasTemplateSvgComponent backgroundColor={'#CEF5FF'} mainColor={'#002B7A'} x={x} y={y} title={title} opacity={opacity} {...props}>
